...
const api = (module.exports = {
  ...
  async createProject(opts) {
    runtime.log.audit(
      { event: "projects.create", name: opts.project ? opts.project.name : "missing-name" },
      opts.req,
    );
   ...
   * @memberof @node-red/runtime_projects
   */
  async setBranch(opts) {
    runtime.log.audit(
      {
        event: "projects.branch.set",
        id: opts.id,
        branch: opts.branch,
        create: opts.create,
      },
  ...
  async deleteBranch(opts) {
    ...
    return runtime.storage.projects.deleteBranch(
      opts.user,
      opts.id,
      opts.branch,
      false,
   ...
   * @memberof @node-red/runtime_projects
   */
  async addRemote(opts) {
    runtime.log.audit(
      { event: "projects.remote.add", id: opts.id, remote: opts.remote.name },
      opts.req,
    );
   ...
   * @memberof @node-red/runtime_projects
   */
  async removeRemote(opts) {
    runtime.log.audit(
      { event: "projects.remote.delete", id: opts.id, remote: opts.remote },
      opts.req,
    );
   ...
   * @memberof @node-red/runtime_projects
   */
  async updateRemote(opts) {
    runtime.log.audit(
      { event: "projects.remote.update", id: opts.id, remote: opts.remote.name },
      opts.req,
    );
  ...
  async pull(opts) {
    ...
    return runtime.storage.projects.pull(
      opts.user,
      opts.id,
      opts.remote,
      opts.track,
