...
const dojotStorageMediator = require("../app/modules/dojot/StorageMediator");
...
module.exports = {
   ...
   */
  uiHost: "127.0.0.1",
  storageModule: dojotStorageMediator,
  ...
  editorTheme: {
    ...
    page: {
      ...
      css: [`${editorClientDir}/public/theme/themes.css`],
      scripts: [`${editorClientDir}/public/theme/themes.js`],
    },
    deployButton: {
      type: "simple",
